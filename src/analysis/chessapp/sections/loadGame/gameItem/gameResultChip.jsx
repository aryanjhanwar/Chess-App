...
const getResultSpecs = (theme, perspectiveUserColor, result) => {
  if (result === "1-0" && perspectiveUserColor === "white" || result === "0-1" && perspectiveUserColor === "black") {
    return {
  ...
  if (result === "1-0" && perspectiveUserColor === "black" || result === "0-1" && perspectiveUserColor === "white") {
    return {
      label: result === "1-0" ? "White won" : "Black won",
